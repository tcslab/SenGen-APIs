...
if (isset($_GET["node_name"]) && isset($_GET["resource_name"]) && isset($_GET["value"]) && isset($_GET["unit"])&& isset($_GET["timestamp"]) && isset($_GET["pos_x"]) && isset($_GET["pos_y"]) && isset($_GET["pos_z"]))
{	

		$sql = "insert into measurements (node_name,resource_name,value,unit,timestamp,pos_x,pos_y,pos_z) values (\""
...
{
	$Json->addContent(new textJson("Please provide node_name,resource_name, value, unit, timestamp, pos_x,pos_y and pos_z in arguments."));
}
